...
def main() -> int:
    ...
    instance = "focus-arrow-keys-test"
    ...
    try:
        ...
        print("focus arrow-key checks passed")
        print("ctrl+b down switches to next pane: ok")
        print("ctrl+b repeated down advances focus: ok")
        print("ctrl+b up switches to previous pane: ok")
        print("ctrl+b repeated up rewinds focus: ok")
        return 0
